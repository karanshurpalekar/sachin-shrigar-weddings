...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Design by Sachin Sherigar" },
      { property: "og:title", content: "Design by Sachin Sherigar" },
      { name: "twitter:title", content: "Design by Sachin Sherigar" },
      { name: "description", content: "A luxury wedding planning and decor website for \"Decor by Sachin Sherigar\" showcasing premium services." },
      { property: "og:description", content: "A luxury wedding planning and decor website for \"Decor by Sachin Sherigar\" showcasing premium services." },
      { name: "twitter:description", content: "A luxury wedding planning and decor website for \"Decor by Sachin Sherigar\" showcasing premium services." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/72317d36-fccc-4727-ab24-5b055193f918/id-preview-d6106aad--6b30c4c2-903d-4fa1-953a-948110d7f21a.lovable.app-1778849366796.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/72317d36-fccc-4727-ab24-5b055193f918/id-preview-d6106aad--6b30c4c2-903d-4fa1-953a-948110d7f21a.lovable.app-1778849366796.png" },
    ],
    links: [
